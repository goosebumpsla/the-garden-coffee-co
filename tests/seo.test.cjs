...
test('wedding page uses supplied wedding media with deferred video and responsive photos', () => {
  ...
  for (const name of ['wedding-hero', 'hero-photo', 'wedding-service', 'thompsons-cart', 'thompsons-details', 'matcha-mimosas-guest', 'matcha-mimosas-cart', 'matcha-mimosas-details', 'monogrammed-matcha', 'custom-wedding-menu', 'vineyard-cart']) assert.ok(html.includes(name + '-480.webp'));
